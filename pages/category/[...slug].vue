  ...
  <div class="max-w-screen-3xl mx-auto md:px-6 lg:px-10">
    <div class="mb-20 px-4 md:px-0">
      ...
      <div class="md:flex gap-6">
        ...
        <div class="flex-1"
          :class="{ 'pending-implementation': areProductsMocked }"
        >
  ...
  onBeforeMount(async () => {
    ...
    if (!productStore.categoriesTree) {
      ...
      if (route.params.slug?.length) {
        productStore.setActiveCategoryByPath(route.params.slug as string[])
      } else {
    ...
    // Once the categories are loaded, we can load the products
