<template>
  <div class="col-span-5">
    <div class="md:shadow-lg md:rounded-md md:border md:border-neutral-100 md:sticky md:top-20">
      ...
      <div class="px-4 pb-4 mt-3 md:px-6 md:pb-6 md:mt-0">
        ...
        <SfButton size="lg" class="w-full" @click="$emit('place-order')">
          Place Order
        </SfButton>
        <div class="typography-text-sm mt-4 text-center">
          By placing my order, you agree to our <SfLink href="#">
...
const showPromocode = ref(false) // Static to hide PromoCode input
