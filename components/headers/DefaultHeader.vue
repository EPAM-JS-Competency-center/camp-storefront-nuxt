<template>
  <header class="h-14 md:h-20 flex z-50 md:sticky md:-top-5 md:pt-2.5 bg-green-700 md:shadow-md text-white">
    <div
      ...
      <NuxtLink title="Homepage" class="h-6 md:h-7 -mt-1.5" to="/">
      ...
      <div class="hidden md:block flex-1">
        <form role="search" class="flex">
          <span
            class="flex items-center gap-2 px-4 bg-white rounded-md ring-1 text-neutral-500 hover:ring-primary-700 focus-within:caret-primary-700 active:caret-primary-700 active:ring-primary-700 active:ring-2 focus-within:ring-primary-700 focus-within:ring-2 ring-1 ring-neutral-200 h-[40px] flex-1 focus-within:ring-primary-900 hover:ring-primary-800 active:ring-primary-800 ring-0 ring-transparent"><input
              class="min-w-[80px] w-full text-base outline-none appearance-none text-neutral-900 disabled:cursor-not-allowed disabled:bg-transparent read-only:bg-transparent search-cancel:appearance-none"
              type="search" size="1" placeholder="Search" value="" /><span class="flex items-center"><button type="reset"
                class="mr-4 inline-flex focus:outline invisible">
                ...
                class="inline-flex items-center justify-center font-medium text-base focus-visible:outline focus-visible:outline-offset rounded-md disabled:text-disabled-500 disabled:bg-disabled-300 disabled:shadow-none disabled:ring-0 disabled:cursor-not-allowed p-2 gap-2 text-primary-700 hover:bg-primary-100 hover:text-primary-800 active:bg-primary-200 active:text-primary-900 disabled:bg-transparent rounded-l-none -mr-4 -my-2 !text-gray-500"
                aria-label="search">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                  class="inline-block fill-current w-6 h-6 undefined">
                  <path
      ...
      <nav class="hidden md:flex">
        <SfButtonLink href="/cart" class="relative">
          <SfIconShoppingCart />
          <SfBadge v-if="cartContent > 0" :content="cartContent" class="rounded-full text-xs bg-blue-600" />
        </SfButtonLink>
      </nav>
    </div>
  </header>
