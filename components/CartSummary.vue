  ...
  <div class="col-span-5">
    <div class="md:shadow-lg md:rounded-md md:border md:border-neutral-100">
      ...
      <div class="px-4 pb-4 mt-3 md:px-6 md:pb-6 md:mt-0">
        ...
        <form v-else-if="!orderDetails.discountedAmount" class="flex gap-x-2 py-4 border-y border-neutral-200 mb-4" @submit.prevent="getDiscountByPromoCode">
...
const removePromoCode = async () => {
  ...
  const getDiscountByPromoCode = async () => {
    try {
      ...
      alertsStore.addAlert({ message: 'The discount code was not found or can not be applied.', type: ALERT_TYPE.ERROR })
    }
  }
